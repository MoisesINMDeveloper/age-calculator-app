...
export default function AgeComponent() {
    ...
    return (
        <section className="bg-White w-[90vw] md:h-[53vh] md:w-[37vw] h-[70vh] flex-row items-center justify-center mx-[1.5rem] rounded-t-3xl rounded-l-3xl rounded-br-[6rem] px-4 md:px-[1.5rem] my-[4rem] pt-[1rem]">
